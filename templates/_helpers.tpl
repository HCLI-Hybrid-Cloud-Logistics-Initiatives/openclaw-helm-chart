...
Get config PVC name
*/}}
{{- define "openclaw.configPVCName" -}}
{{- if .Values.persistence.existingClaim.config }}
{{- .Values.persistence.existingClaim.config }}
{{- else }}
...
Get memory PVC name
*/}}
{{- define "openclaw.memoryPVCName" -}}
{{- if .Values.persistence.existingClaim.memory }}
{{- .Values.persistence.existingClaim.memory }}
{{- else }}
{{- include "openclaw.fullname" . }}-memory
{{- end }}
{{- end }}
